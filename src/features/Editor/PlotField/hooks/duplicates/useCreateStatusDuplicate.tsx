...
export default function useCreateStatusDuplicate({ topologyBlockId, episodeId }: CreateDuplicateTypes) {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      await axiosCustomized
        .post(`/plotFieldCommands/status/topologyBlocks/${currentTopologyBlockId}/copy`, {
          commandOrder,
          plotfieldCommandId,
          plotfieldCommandIfId,
          isElse,
