...
export default function useCreateStatDuplicate({ topologyBlockId, episodeId }: CreateDuplicateTypes) {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      await axiosCustomized
        .post(`/plotFieldCommands/stats/topologyBlocks/${currentTopologyBlockId}/copy`, {
          commandOrder,
          plotfieldCommandId,
          plotfieldCommandIfId,
          isElse,
