...
export default function useCreateRelationDuplicate({ topologyBlockId, episodeId }: CreateDuplicateTypes) {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      await axiosCustomized
        .post(`/plotFieldCommands/relationCommands/topologyBlocks/${currentTopologyBlockId}/copy`, {
          commandOrder,
          plotfieldCommandId,
          plotfieldCommandIfId,
          isElse,
