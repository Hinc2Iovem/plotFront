...
export type AllPossibleCommandUndoTypes = "copied" | "deleted" | "created";
...
export type PlotfieldOptimisticUndoCommandTypes = CommandUndoType &
...
const usePlotfieldCommandPossiblyBeingUndo =
  create<PlotfieldCommandsPossiblyBeingUndoTypes>()(
    devtools(
      (set, get) => ({
        allCommands: [],
          ...
          set((state) => {
            ...
            if (currentCommands) {
              ...
              return {
                allCommands: [
                  ...state.allCommands,
                  { commands: [newCommand], episodeId, topologyBlockId },
                ],
              };
            }
          }),
                  ...
                  ? {
                      ...
                      commands: c.commands.map((command) =>
                        command._id === commandId
                          ? { ...command, currentUndoStatus: commandStatus }
                          : command
                      ),
                    }
                  : c
