...
export default function StoryFooter() {
  ...
  return (
    <footer className="w-full bg-secondary mt-[3rem]">
      <div className="max-w-[148rem] mx-auto flex flex-col gap-[1rem] p-[1rem]">
        <div className="flex gap-[1rem] items-baseline sm:flex-row flex-col">
          <h3 className="text-[3rem] text-text-light opacity-80">
          ...
          <p
            className={`text-[1.5rem] ${
              storyStatus === "doing"
                ? "text-orange-300"
                : `${theme === "light" ? "text-green-200" : "text-green-500"}`
            }`}
          >
            {storyStatus === "doing" ? "(В процессе)" : "(Завершена)"}
          </p>
        </div>
        <h4 className="text-[2.5rem] text-text-light opacity-60">Сценаристы</h4>
  ...
  return (
    <div
      className={`${
        currentStoryStatus === "doing"
          ? `${
              theme === "light"
                ? "bg-orange-200 text-text-dark"
                : "bg-orange-400 text-text-light"
            }`
          : ` ${
              theme === "light"
    ...
    >
      <button
        ...
        className={` ${
          ...
          staff?.roles.includes("headscriptwriter")
            ...
            : ""
        } outline-none w-full p-[.5rem] flex items-center gap-[.5rem]`}
      >
      ...
      <aside
        ...
        } absolute z-[2] shadow-sm bg-secondary rounded-md top-0 w-full h-full p-[.5rem]`}
      >
          ...
          <button
            ...
            className={`${
              currentStoryStatus === "doing"
                ...
                : `${
                    theme === "light" ? "text-green-300" : "text-green-500"
                  } outline-green-300 hover:text-orange-300 hover:outline-orange-300 transition-all`
