...
export default function useDuplicateFocusedCommandCutScene({
  topologyBlockId,
}: DuplicateFocusedCommandCutSceneTypes) {
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      if (
        ...
        if ((currentFocusedPlotfieldCommand || [])[0] !== "cutscene") {
          console.log("Not an cutscene");
          return;
        }
