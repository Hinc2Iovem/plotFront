...
export default function useDuplicateFocusedCommandGetItem({
  topologyBlockId,
}: DuplicateFocusedCommandGetItemTypes) {
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      if (
        ...
        if ((currentFocusedPlotfieldCommand || [])[0] !== "getitem") {
          console.log("Not an getItem");
          return;
        }
