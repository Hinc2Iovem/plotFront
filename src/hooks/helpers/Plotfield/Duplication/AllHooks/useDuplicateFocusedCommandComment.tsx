...
export default function useDuplicateFocusedCommandComment({
  topologyBlockId,
}: DuplicateFocusedCommandCommentTypes) {
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      if (
        ...
        if ((currentFocusedPlotfieldCommand || [])[0] !== "comment") {
          console.log("Not an comment");
          return;
        }
