...
export default function useDuplicateFocusedCommandWardrobe({
  topologyBlockId,
}: DuplicateFocusedCommandWardrobeTypes) {
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      if (
        ...
        if ((currentFocusedPlotfieldCommand || [])[0] !== "wardrobe") {
          console.log("Not an wardrobe");
          return;
        }
