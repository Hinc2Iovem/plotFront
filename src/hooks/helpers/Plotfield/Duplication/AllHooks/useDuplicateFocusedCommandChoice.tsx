...
export default function useDuplicateFocusedCommandChoice({
  topologyBlockId,
}: DuplicateFocusedCommandChoiceTypes) {
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      if (
        ...
        if ((currentFocusedPlotfieldCommand || [])[0] !== "choice") {
          console.log("Not an choice");
          return;
        }
