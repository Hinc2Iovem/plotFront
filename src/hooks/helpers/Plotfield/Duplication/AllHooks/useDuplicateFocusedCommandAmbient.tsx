...
export default function useDuplicateFocusedCommandAmbient({
  topologyBlockId,
}: DuplicateFocusedCommandAmbientTypes) {
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      if (
        ...
        if ((currentFocusedPlotfieldCommand || [])[0] !== "ambient") {
          console.log("Not an ambient");
          return;
        }
