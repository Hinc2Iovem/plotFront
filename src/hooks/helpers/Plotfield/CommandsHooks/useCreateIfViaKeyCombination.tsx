...
import useCreateCommandIf from "../../../../features/Editor/PlotField/hooks/If/useCreateCommandIf";
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      if (
        ...
        ((pressedKeys.has("i") && pressedKeys.has("f")) || (pressedKeys.has("ш") && pressedKeys.has("а")))
      ) {
